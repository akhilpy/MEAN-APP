...
describe('Mail API:', function() {
  ...
  describe('POST /api/mails', function() {
    beforeEach(function(done) {
      request(app)
        ...
        .send({
          ...
          to: 'ind@staging.work',
          subject: 'New Mail',
          html: 'This is the brand new mail!!!'
        })
        .expect(201)
        .expect('Content-Type', /json/)
        .end((err, res) => {
    ...
    it('should respond with the newly created mail', function() {
      newMail.subject.should.equal('New Mail');
      newMail.html.should.equal('This is the brand new mail!!!');
    });
  ...
  describe('GET /api/mails/:id', function() {
    ...
    it('should respond with the requested mail', function() {
      mail.subject.should.equal('New Mail');
      mail.html.should.equal('This is the brand new mail!!!');
    });
  ...
  describe('PUT /api/mails/:id', function() {
    ...
    it('should respond with the updated mail', function() {
      updatedMail.subject.should.equal('Updated Mail');
      updatedMail.html.should.equal('This is the updated mail!!!');
    });
