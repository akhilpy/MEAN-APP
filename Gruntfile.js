// Generated on 2016-01-26 using generator-angular-fullstack 3.3.0-beta.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      sass: {
        files: ['<%= yeoman.client %>/{app,components,sass}/**/*.{scss,sass}'],
        tasks: ['sass', 'postcss']
      },
      gruntfile: {
        files: ['Gruntfile.js']
    ...
    ngconstant: {
      options: {
        name: 'investnextdoorCaApp.constants',
