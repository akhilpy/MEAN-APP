...
describe('Directive: oauthButtons', function() {
  ...
  it('should contain anchor buttons', function() {
    ...
    expect(element.find('a.social-button').length).toBeGreaterThan(0);
  });
  ...
  it('should bind scope.classes to class names on the anchor buttons', function() {
    ...
    elementScope.$digest();
    expect(element.find('a.social-button.testClass1.testClass2').length).toBeGreaterThan(0);

    // Remove classes
    elementScope.classes = '';
    elementScope.$digest();
    expect(element.find('a.social-button.testClass1.testClass2').length).toEqual(0);
  });
});
