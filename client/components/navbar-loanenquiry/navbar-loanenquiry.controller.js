...
class NavbarLoanenquiryController {
  constructor(Auth, appConfig, $scope, ListingService , Borrower ) {
    var vm = this;
    vm.$scope = $scope;
...
angular.module('investnextdoorCaApp')
  .controller('NavbarLoanenquiryController', NavbarLoanenquiryController);
